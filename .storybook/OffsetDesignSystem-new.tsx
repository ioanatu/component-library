/**
 * OFFSET Design System — v2.0.0
 * Single-file React + TypeScript documentation site.
 *
 * Usage:
 *   import OffsetDesignSystem from './OffsetDesignSystem';
 *   <OffsetDesignSystem />
 *
 * Requires: react >= 18. No other dependencies.
 * Fonts (Hanken Grotesk + JetBrains Mono) are injected at mount.
 */
